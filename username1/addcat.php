...
<div id="container">
  ...
  <div id="mainContent">
    ...
    <div id="middletxtheadermain">
      ...
      <div id="middletxt1">
        <p>Enter the details of  Category and Sub Category.</p>
      </div>
      </div>
      <div id="middletxt">
          ...
          <table width="100%" border=0>
            <tr>
              <td height="22"><table width="100%" border=0>
                  ...
                  <tr>
                    <td><div align="right"><strong><font color="#FF0000">*</font>Sub Category : </strong></div></td>
                    <td width="128"><input type="textbox" name="txt_subcat" id="txt_subcat"  value="" maxlength="30" style="width:176px;"
                                      onchange="document.getElementById('txt_subcat').value=trim(this.value);"/></td>
                  </tr>
                   <tr>
...
<!-- Code for inserting into data base -->
 <?php
  if(isset($_POST['submitMain']))
  {
   ...
   $query = mysql_query("INSERT INTO t_category_mst (cat_category,cat_sub_category,cat_descreption) VALUES ('$cat','$subcat','$catdec')")
    or die(mysql_error());
