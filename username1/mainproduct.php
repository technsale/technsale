...
<div id="subsidebar2">
 ...
 ?>
  ...
  <div id="mainContent">
	...
	$query="SELECT COUNT(*) as num FROM t_product_mst WHERE username= '$username' AND prd_cat= '$cat' AND prd_sub_cat= '$sub' AND prd_status='Available' ";
	...
	<!-- MSTableType="layout" -->
<?php
    $get= @mysql_query("SELECT * FROM t_product_mst WHERE username= '$username' AND prd_cat= '$cat' AND prd_sub_cat= '$sub' AND prd_status='Available' LIMIT $start, $limit ")or die(mysql_error());
 ...
 <tr>
    ...
    </p></td>    <td width="250"><p align="center">Discription : <br/><?php echo $pldis;?> <br/>
                    <?php if($psize=="") { } else {?>
