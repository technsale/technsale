	  ...
	  <tr>
                 ...
                 <td width="128"><select name="selcountry" id="selcountry" style="width:180px;">
	                         <option value="selcountry">--Select--</option>
                                 <?php
                                  $get_cty=mysql_query("SELECT country_name FROM t_country")or die(mysql_error());
 ...
 <?php
	if(isset($_POST['btnremove']))
	 ...
	 for($i=0;$i<$num;$i++)
	   ...
	   $query = mysql_query("INSERT INTO t_orders_trn (prd_id,username,ord_pname,ord_qty,ord_price,ord_fname,ord_lname,ord_odate,ord_ddate,ord_email,ord_baddress,ord_saddress,ord_country,ord_mobile,ord_phone,ord_deliverystatus,ord_sid)
