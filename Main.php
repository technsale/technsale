...
<?php
	...
	$query="SELECT COUNT(*) as num FROM t_product_mst WHERE username = '$username' AND prd_status='Available'";
	...
	$get= @mysql_query("SELECT * FROM t_product_mst WHERE username='$username' AND prd_status='Available' LIMIT $start, $limit ")or die(mysql_error());
