...
<div id="container">
 ...
 <?php
  ...
  for($i=0;$i<$num;$i++)
  {
   ...
   $mob=@mysql_result($get,$i,'og_mobile');
 ...
 <?php
  if($_POST['submitMain'])
  {
   ...
   // Update Query 
   $query = mysql_query("UPDATE t_custreg_mst SET log_sal='$sal',log_fname='$fname',log_lname='$lname',log_email='$email',log_address='$add',log_country='$country',
